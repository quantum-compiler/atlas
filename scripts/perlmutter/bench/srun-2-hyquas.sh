...
for str in "${strings[@]}"; do
    ...
    srun -u \
     ...
     --ntasks-per-node=1\
    ./main /global/homes/m/mingkuan/torque/circuit/MQTBench_31q/${str}_indep_qiskit_31_no_swap.qasm > /global/homes/m/mingkuan/result-srun/hyquas-new/on_${str}_31.log
done
