...
for str in "${strings[@]}"; do
    ...
    srun -u \
         ...
         --ntasks-per-node=1\
         /global/homes/m/mingkuan/torque/build/examples/mpi-based/simulate --import-circuit ${str} --n 33 --local 28 --device 4 --use-ilp > /global/homes/m/mingkuan/result-srun/torque-new/${str}_33.log
done