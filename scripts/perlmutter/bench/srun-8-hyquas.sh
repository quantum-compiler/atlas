...
for str in "${strings[@]}"; do
    ...
    srun -u \
     ...
     --ntasks-per-node=1\
    ./main /global/homes/m/mingkuan/torque/circuit/MQTBench_33q/${str}_indep_qiskit_33_no_swap.qasm > /global/homes/m/mingkuan/result-srun/hyquas-new/on_${str}_33.log
done