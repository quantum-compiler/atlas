...
cp(0.89498683) psi[0],q[4];
cp(1.7899737) psi[0],q[5];
cp(-2.703238) psi[0],q[6];
cp(0.87670934) psi[0],q[7];
cp(1.7534187) psi[0],q[8];
cp(-2.7763479) psi[0],q[9];
cp(0.73048944) psi[0],q[10];
cp(1.4609789) psi[0],q[11];
cp(2.9219578) psi[0],q[12];
cp(-0.43926978) psi[0],q[13];
cp(-0.87853956) psi[0],q[14];
cp(-1.7570791) psi[0],q[15];
cp(2.7690271) psi[0],q[16];
cp(-0.74513117) psi[0],q[17];
cp(-1.4902623) psi[0],q[18];
cp(-2.9805247) psi[0],q[19];
cp(0.32213597) psi[0],q[20];
cp(0.64427193) psi[0],q[21];
cp(1.2885439) psi[0],q[22];
cp(2.5770877) psi[0],q[23];
cp(-1.1290099) psi[0],q[24];
cp(-2.2580197) psi[0],q[25];
cp(9*pi/16) psi[0],q[26];
cp(-7*pi/8) psi[0],q[27];
cp(pi/4) psi[0],q[28];
cp(pi/2) psi[0],q[29];
swap q[0],q[29];
h q[0];
