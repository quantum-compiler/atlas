...
cp(-0.21913648) psi[0],q[1];
cp(-0.43827296) psi[0],q[2];
cp(-0.87654592) psi[0],q[3];
cp(-1.7530918) psi[0],q[4];
cp(2.7770016) psi[0],q[5];
cp(-0.72918204) psi[0],q[6];
cp(-1.4583641) psi[0],q[7];
cp(-2.9167281) psi[0],q[8];
cp(0.44972901) psi[0],q[9];
cp(0.89945802) psi[0],q[10];
cp(1.798916) psi[0],q[11];
cp(-2.6853532) psi[0],q[12];
cp(0.91247888) psi[0],q[13];
cp(1.8249578) psi[0],q[14];
cp(-2.6332698) psi[0],q[15];
cp(1.0166458) psi[0],q[16];
cp(2.0332915) psi[0],q[17];
cp(-2.2166022) psi[0],q[18];
cp(1.8499808) psi[0],q[19];
cp(-2.5832236) psi[0],q[20];
cp(1.116738) psi[0],q[21];
cp(2.233476) psi[0],q[22];
cp(-1.8162333) psi[0],q[23];
cp(2.6507188) psi[0],q[24];
cp(-5*pi/16) psi[0],q[25];
cp(-5*pi/8) psi[0],q[26];
cp(3*pi/4) psi[0],q[27];
cp(-pi/2) psi[0],q[28];
swap q[0],q[28];
h q[0];
swap q[1],q[27];
