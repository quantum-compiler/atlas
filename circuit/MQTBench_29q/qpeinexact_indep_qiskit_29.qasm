...
cp(-0.21913649) psi[0],q[1];
cp(-0.43827298) psi[0],q[2];
cp(-0.87654596) psi[0],q[3];
cp(-1.7530919) psi[0],q[4];
cp(2.7770014) psi[0],q[5];
cp(-0.72918241) psi[0],q[6];
cp(-1.4583648) psi[0],q[7];
cp(-2.9167296) psi[0],q[8];
cp(0.44972602) psi[0],q[9];
cp(0.89945203) psi[0],q[10];
cp(1.7989041) psi[0],q[11];
cp(-2.6853772) psi[0],q[12];
cp(0.91243095) psi[0],q[13];
cp(1.8248619) psi[0],q[14];
cp(-2.6334615) psi[0],q[15];
cp(1.0162623) psi[0],q[16];
cp(2.0325245) psi[0],q[17];
cp(-2.2181362) psi[0],q[18];
cp(1.8469129) psi[0],q[19];
cp(-2.5893596) psi[0],q[20];
cp(1.1044662) psi[0],q[21];
cp(2.2089323) psi[0],q[22];
cp(-1.8653206) psi[0],q[23];
cp(13*pi/16) psi[0],q[24];
cp(-3*pi/8) psi[0],q[25];
cp(-3*pi/4) psi[0],q[26];
cp(pi/2) psi[0],q[27];
swap q[0],q[27];
h q[0];
swap q[1],q[26];
